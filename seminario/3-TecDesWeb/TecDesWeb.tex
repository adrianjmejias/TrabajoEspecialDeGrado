...
Así entonces se logra al perfecto balance de herramientas actuales y fáciles de usar, que también cumplen con los requerimientos de los motores de búsqueda para indexar páginas web.
...
Como se puede observar en la imagen \ref{fig:db-ranking}, mongoDB es actualmente la opción más usada entre las bases de datos NoSQL, ocupando el puesto número 5 en el ranking de bases de datos. Esto proporciona suficiente certeza de que MongoDB será mantenido por años en el futuro.
