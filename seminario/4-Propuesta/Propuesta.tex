...
\begin{enumerate}
    ...
    \item Proveer una forma visual de ver el desarrollo general de los artículos (crecimiento de articulo, detection de actividad maliciosa, entre otras cosas).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{proyectos-relacionados/sigma-summary.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.5]{proyectos-relacionados/rdm-historyflow.png}
